...
function Cards() {
  return (
    <div>
      <div className=''>
        <section className=' h-3/5 flex items-center text-gray-600'>
           <div className='container px-5 py-24 mx-auto'>
             <div className='text-center md-12'>
               <h1 className='mb-14 text-4xl md:text-6xl text-gray-700 font-semibold'>
                  A few projects of mine! 
               </h1>
               <div data-aos="zoom-in" className='flex flex-wrap m-4'>
                  <div  className='p-4 sm:w-1/2 lg:w-1/3'>
                     <div className='h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden'>
                        <img src="card1.png" alt="image" className='lg:h-72 md:h-48 w-full object-cover object-center' />
                        <div className='bg-white p-6 hover:bg-purple-600 hover:text-white transition duration-300  ease-in'>
                  ...
                  <div data-aos="zoom-in" className='p-4 sm:w-1/2 lg:w-1/3' >
                     <div className='h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden'>
                        <img src="card2.png" alt="image" className='lg:h-72 md:h-48 w-full object-cover object-center' />
                        <div className='bg-white p-6 hover:bg-purple-600 hover:text-white transition duration-300  ease-in'>
                             <h2 className='text-base font-medium text-indigo-300 mb-1'>Published on October 2024</h2>
                  ...
                  <div data-aos="zoom-in" className='p-4 sm:w-1/2 lg:w-1/3' >
                     <div className='h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden'>
                        <img src="card3.png" alt="image" className='lg:h-72 md:h-48 w-full object-cover object-center' />
                        <div className='bg-white p-6 hover:bg-purple-600 hover:text-white transition duration-300  ease-in'>
                             <h2 className='text-base font-medium text-indigo-300 mb-1'>Published on October 2024</h2>
